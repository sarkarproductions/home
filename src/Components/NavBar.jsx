...
function NavBar(props) {
  ...
  <div className="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="#contact" className="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">{props.arg3}</a>
  ...
  <div id="navDemo" className={display}>
    ...
    <a href="#services" className="w3-bar-item w3-button w3-padding-large">Services</a>
    <a href="#about" className="w3-bar-item w3-button w3-padding-large">About</a>
    <a href="#contact" className="w3-bar-item w3-button w3-padding-large">Contact us</a>
